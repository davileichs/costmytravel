      ...
      <div class="card-body border-bottom mb-1 bg-white text-dark">
          <div class="row">
              <div class="col-12 col-sm-6">
                  ...
                  <p><a data-toggle="collapse" href="#collapseDetails" role="button" aria-expanded="false" aria-controls="collapseDetails{{ $i }}">Details</a></p>
              </div>
              <div class="col-12 col-sm-6 text-right">
                  <a href="{{  $route->url }}" class="btn btn-kiwi" target="_blank">Check on Kiwi</a>
              </div>
              <div class="col-12 collapse" id="collapseDetails{{ $i }}">
